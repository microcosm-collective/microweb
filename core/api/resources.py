...
COMMENTABLE_ITEM_TYPES = ["event", "conversation", "poll", "huddle"]
    ...
    for response in responses:
        ...
        if response is not None:
            ...
            if response.history:
                ...
                response_dict[discard_querystring(response.url)] = (
                    APIResource.process_response(response.url, response)
                )
    return response_dict
...
class APIResource(object):
    ...
    def process_response(url, response):
        ...
        if resource["error"]:
            raise APIException(
                resource["error"], response.status_code, detail=resource["data"]
            )
    ...
    def delete(url, params, headers):
        ...
        try:
            ...
            raise APIException(
                "The API has returned invalid json: %s" % response.content, 500
            )
        if resource["error"]:
...
class Site(object):
    ...
    def __init__(self, data):
        ...
        if data.get("gaWebPropertyId"):
            self.ga_web_property_id = data["gaWebPropertyId"]
...
class User(object):
    ...
    def retrieve(host, id, access_token):
        ...
        resource = APIResource.retrieve(
            url, {}, APIResource.make_request_headers(access_token)
        )
...
class Profile(object):
    ...
    def update(self, host, access_token):
        ...
        resource = APIResource.update(
            url, payload, {}, APIResource.make_request_headers(access_token)
        )
        return Profile(resource, summary=False)
    ...
    def as_dict(self):
        ...
        if hasattr(self, "site_id"):
            repr["siteId"] = self.site_id
        if hasattr(self, "user_id"):
            repr["userId"] = self.user_id
        if hasattr(self, "profile_name"):
            repr["profileName"] = self.profile_name
        if hasattr(self, "visible"):
            repr["visible"] = self.visible
        if hasattr(self, "avatar"):
            repr["avatar"] = self.avatar
        if hasattr(self, "style_id"):
            repr["styleId"] = self.style_id
        if hasattr(self, "item_count"):
            repr["itemCount"] = self.item_count
        if hasattr(self, "comment_count"):
            repr["commentCount"] = self.comment_count
        if hasattr(self, "created"):
            repr["created"] = self.created
        if hasattr(self, "last_active"):
            repr["lastActive"] = self.last_active
        if hasattr(self, "banned"):
            repr["banned"] = self.banned
        if hasattr(self, "admin"):
            repr["admin"] = self.admin
        if hasattr(self, "is_member"):
            repr["member"] = self.is_member

        if hasattr(self, "profile_comment"):
            repr["markdown"] = self.profile_comment.markdown
    ...
    def get_unread_count(host, access_token):
        ...
        return APIResource.retrieve(
            url, {}, headers=APIResource.make_request_headers(access_token)
        )
...
class Microcosm(APIResource):
    ...
    def from_api_response(cls, data):
        ...
        if data.get("siteId"):
            microcosm.site_id = data["siteId"]
        if data.get("visibility"):
            microcosm.visibility = data["visibility"]
        if data.get("title"):
            microcosm.title = data["title"]
        if data.get("description"):
            microcosm.description = data["description"]
        if data.get("logoUrl"):
            microcosm.logoUrl = data["logoUrl"]
        if data.get("removeLogo"):
            microcosm.removeLogo = data["removeLogo"]
        if data.get("moderators"):
            microcosm.moderators = data["moderators"]
        if data.get("editReason"):
            microcosm.edit_reason = data["editReason"]
        if data.get("meta"):
            microcosm.meta = Meta(data["meta"])
        if data.get("items"):
            microcosm.items = PaginatedList(data["items"], Item)
        if data.get("itemTypes"):
            microcosm.item_types = data["itemTypes"]
        if data.get("children"):
            microcosm.children = ChildLinks(data["children"])
    ...
    def from_summary(cls, data):
        ...
        if data.get("totalItems"):
            microcosm.total_items = data["totalItems"]
        if data.get("totalComments"):
            microcosm.total_comments = data["totalComments"]
        return microcosm
    ...
    def as_dict(self):
        ...
        if hasattr(self, "parent_id"):
            repr["parentId"] = self.parent_id
        if hasattr(self, "site_id"):
            repr["siteId"] = self.site_id
        if hasattr(self, "visibility"):
            repr["visibility"] = self.visibility
        if hasattr(self, "title"):
            repr["title"] = self.title
        if hasattr(self, "description"):
            repr["description"] = self.description
        if hasattr(self, "logoUrl"):
            repr["logoUrl"] = self.logoUrl
        if hasattr(self, "removeLogo"):
            repr["removeLogo"] = self.removeLogo
        if hasattr(self, "moderators"):
            repr["moderators"] = self.moderators
        if hasattr(self, "meta"):
            repr["meta"] = self.meta
        if hasattr(self, "most_recent_update"):
            repr["mostRecentUpdate"] = self.most_recent_update
        if hasattr(self, "total_items"):
            repr["totalItems"] = self.total_items
        if hasattr(self, "total_comments"):
            repr["totalComments"] = self.total_comments
        if hasattr(self, "items"):
            repr["items"] = self.items
        if hasattr(self, "item_types"):
            repr["itemTypes"] = self.item_types
        if hasattr(self, "edit_reason"):
            repr["meta"] = dict(editReason=self.edit_reason)
        return repr
...
class Role(APIResource):
    ...
    def update_api(host, data, access_token):
        url = build_url(
            host, ["microcosms/", str(data.microcosm_id), "/roles/", str(data.id)]
        )
        headers = APIResource.make_request_headers(access_token)
        headers["Content-Type"] = "application/json"
        return requests.put(
            url,
            data=json.JSONEncoder().encode(data.as_dict()),
            headers=headers,
    ...
    def delete_api(host, microcosm_id, role_id, access_token):
        url = build_url(
            host, ["microcosms/", str(microcosm_id), "/roles/", str(role_id)]
        )
...
class RoleProfile(APIResource):
    ...
    def update_api(host, microcosm_id, role_id, data, access_token):
        url = build_url(
            host,
            ["microcosms/", str(microcosm_id), "/roles/", str(role_id), "/profiles"],
        )
        headers = APIResource.make_request_headers(access_token)
        headers["Content-Type"] = "application/json"
...
class RoleProfileList(object):
    ...
    def retrieve(host, microcosm_id, id, offset=None, access_token=None):
        url, params, headers = RoleProfileList.build_request(
            host, microcosm_id, id, offset, access_token
        )
        resource = APIResource.retrieve(url, params, headers)
...
class RoleCriteria(APIResource):
    ...
    def create_api(host, microcosm_id, role_id, data, access_token):
        url = build_url(
            host,
            ["microcosms/", str(microcosm_id), "/roles/", str(role_id), "/criteria"],
        )
        headers = APIResource.make_request_headers(access_token)
        headers["Content-Type"] = "application/json"
        return requests.post(url, data=json.dumps(data.as_dict()), headers=headers)
...
class RoleCriteriaList(object):
    ...
    @staticmethod
    def retrieve(host, microcosm_id, id, offset=None, access_token=None):
        url, params, headers = RoleCriteriaList.build_request(
            host, microcosm_id, id, offset, access_token
        )
        resource = APIResource.retrieve(url, params, headers)
    ...
    def from_summary(cls, data):
        ...
        if data["item"].get("lastComment"):
            ...
            if data["item"]["lastComment"].get("createdBy"):
                item.last_comment_created_by = Profile(
                    data["item"]["lastComment"]["createdBy"]
                )
            if data["item"]["lastComment"].get("created"):
                item.last_comment_created = parse_timestamp(
                    data["item"]["lastComment"]["created"]
                )
...
class PaginatedList(object):
    ...
    def __init__(self, item_list, list_item_cls):
        ...
        if item_list.get("items"):
            self.items = [
                list_item_cls.from_summary(item) for item in item_list["items"]
            ]
        else:
            self.items = []
        self.links = {}
...
class Meta(object):
    ...
    def __init__(self, data):
        ...
        if data.get("createdBy"):
            self.created_by = Profile(data["createdBy"])
        if data.get("edited"):
            self.edited = parse_timestamp(data["edited"])
        if data.get("editedBy"):
            self.edited_by = Profile(data["editedBy"])
        if data.get("flags"):
            self.flags = data["flags"]
        if data.get("permissions"):
            self.permissions = PermissionSet(data["permissions"])
    ...
    def __init__(self, data):
        ...
        if data.get("item"):
            if data.get("itemType") == "conversation":
                ...
                self.item_link = "/%s/%s/newest/" % (
                    RESOURCE_PLURAL[data.get("itemType")],
                    self.item_id,
                )

                if data["item"].get("lastCommentCreated"):
                    self.item.last_comment_created = parse_timestamp(
                        data["item"]["lastCommentCreated"]
                    )
                else:
                    self.item.last_comment_created = parse_timestamp(
                        data["item"]["meta"]["created"]
                    )
                ...
                if data["item"].get("mostRecentUpdate"):
                    self.item.last_comment_created = parse_timestamp(
                        data["item"]["mostRecentUpdate"]["item"]["meta"]["created"]
                    )
                else:
                    self.item.last_comment_created = parse_timestamp(
                        data["item"]["meta"]["created"]
...
class Update(APIResource):
    ...
    def from_api_response(cls, data):
        ...
        if data.get("parentItem"):
            ...
            update.parent_item = populate_item(
                update.parent_item_type, data["parentItem"]
            )
        else:
            update.parent_item = update.item

        update.item_link = "/%s/%s" % (
            RESOURCE_PLURAL[update.item_type],
            update.item.id,
        )
    ...
    def retrieve(host, update_id, access_token):
        ...
        return Update.from_api_response(
    ...
    def update(self, host, access_token):
        ...
        response = APIResource.update(
            url, payload, headers=APIResource.make_request_headers(access_token)
        )
...
class UpdatePreference(APIResource):
    ...
    def update(host, update_type_id, data, access_token):
        ...
        resource = APIResource.update(
            url, json.dumps(data), {}, APIResource.make_request_headers(access_token)
        )
...
class Conversation(APIResource):
    ...
    def from_summary(cls, data):
        ...
        if data.get("lastComment"):
            ...
            conversation.last_comment_created_by = Profile(
                data["lastComment"]["createdBy"]
            )
            conversation.last_comment_created = parse_timestamp(
    ...
    def newest(host, id, access_token=None):
        ...
        resource = APIResource.retrieve(
            url, params={}, headers=APIResource.make_request_headers(access_token)
        )
        return resource
...
class Huddle(APIResource):
    ...
    def from_summary(cls, data):
        ...
        if data.get("lastCommentId"):
            huddle.last_comment_id = data["lastCommentId"]
    ...
    def invite(host, id, profileIds, access_token=None):
        ...
        resource = APIResource.update(
            url, json.dumps(payload), {}, APIResource.make_request_headers(access_token)
        )
        return Huddle.from_api_response(resource)
...
class Event(APIResource):
    ...
    def from_summary(cls, data):
        ...
        if data.get("rsvpAttend"):
            event.rsvp_attend = data["rsvpAttend"]
        if data.get("rsvpSpaces"):
            event.rsvp_spaces = data["rsvpSpaces"]
        ...
        if event.rsvp_limit > 0:
            if data.get("rsvpAttend"):
                event.rsvp_percentage = (
                    event.rsvp_attend / float(event.rsvp_limit)
                ) * 100
        ...
        if data.get("tz"):
            event.tz = data["tz"]
        if data.get("whentz"):
            event.whentz = parse_timestamp(data["whentz"], ignoretz=True)
        if data.get("where"):
    ...
    def as_dict(self, update=False):
        ...
        if hasattr(self, "rsvp_attend"):
            repr["rsvpAttend"] = self.rsvp_attend
        if hasattr(self, "rsvp_limit"):
            repr["rsvpLimit"] = self.rsvp_limit
        if hasattr(self, "rsvp_spaces"):
            repr["rsvpSpaces"] = self.rsvp_spaces
    ...
    def rsvp_api(cls, host, event_id, profile_id, attendance_data, access_token):
        ...
        return requests.put(
            url,
            data=json.JSONEncoder().encode(attendance_data),
            headers=headers,
            allow_redirects=False,
        )
...
class GeoCode(object):
    ...
    def retrieve(cls, host, q, access_token):
        ...
        headers = APIResource.make_request_headers(access_token)
        response = requests.get(
            build_url(host, ["geocode"]), params=params, headers=headers
        )
        return response.content
...
class FileMetadata(object):
    ...
    def create(self, host, access_token, width=0, height=0):
        ...
        headers = APIResource.make_request_headers(access_token)
        response = APIResource.process_response(
            url, requests.post(url, files=self.file, headers=headers)
        )
...
class Attachment(object):
    ...
    def retrieve(host, type, id, offset=None, access_token=None):
        url, params, headers = Attachment.build_request(
            host, type, id, offset, access_token
        )
        resource = APIResource.retrieve(url, params, headers)
    ...
    def create(
        ...
        if profile_id:
            ...
            raise AssertionError(
                "You must supply a profile_id or comment_id to attach to"
            )

        attachment = {"FileHash": file_hash, "FileName": file_name}
        headers = APIResource.make_request_headers(access_token)
        return APIResource.process_response(
            url, requests.post(url, data=attachment, headers=headers)
        )
...
class SearchResult(object):
    ...
    def from_api_response(cls, data):
        ...
        if data.get("parentItem"):
            ...
            searchresult.parent_item = populate_item(
                searchresult.parent_item_type, data["parentItem"]
            )
...
class Trending(APIResource):
    ...
    def from_api_response(cls, data):
        trending = cls()
        if data.get("meta"):
            trending.meta = Meta(data["meta"])
        if data.get("items"):
            trending.items = PaginatedList(data["items"], Item)
        return trending
